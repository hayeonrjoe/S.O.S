document.addEventListener('DOMContentLoaded', function () {
    ...
    if (loadAction === '/online-complaint/admin/l/load-latest') {
        fetchLatestResults()
            .then(() => {
    ...
    function fetchLatestResults() {
        return fetch('/online-complaint/admin/l/latest-results')
    ...
    function attachRowClickListener() {
        ...
        Array.from(rows).forEach(function(row) {
            row.addEventListener("click", function() {
                ...
                window.location.href = "/online-complaint-comment-form/admin/l?num=" + ocId;
            });
        });
    }
